...
--Percent symbol %
SELECT name,
CONCAT(ROUND((100*population/(SELECT population FROM world WHERE name = 'Germany'))),'%') FROM world WHERE continent = 'Europe'
...
SELECT continent,name FROM world x WHERE name<= 
